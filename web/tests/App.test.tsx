...
describe('C2Hunter UI', () => {
  ...
  it('renders candidates with normalized optional fields', async () => {
    ...
    expect(screen.getByText('3회 탐지 · 중복 2건 통합')).toBeInTheDocument();
