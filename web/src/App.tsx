...
type CandidateFilters = { severity: string; workflowStatus: string; minimumScore: string; includeSuppressed: boolean; sort: string };
const defaultCandidateFilters: CandidateFilters = { severity: '', workflowStatus: '', minimumScore: '0', includeSuppressed: false, sort: '-last_seen' };
